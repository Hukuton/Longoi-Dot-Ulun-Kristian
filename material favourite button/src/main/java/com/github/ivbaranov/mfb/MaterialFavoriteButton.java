...
public class MaterialFavoriteButton extends ImageView {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        if (attr != null) {
            try {
                mAnimateFavorite = attr.getBoolean(R.styleable.MaterialFavoriteButton_mfb_animate_favorite, mAnimateFavorite);
                mAnimateUnfavorite = attr.getBoolean(R.styleable.MaterialFavoriteButton_mfb_animate_unfavorite, mAnimateUnfavorite);
